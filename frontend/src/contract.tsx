...
export const getBalance = async (pass: string) => {
    const callValue = await contract.query.balanceOf(ACCOUNT_ADDRESS, { gasLimit }, {pass});
    console.log(callValue.result.toJSON());
}